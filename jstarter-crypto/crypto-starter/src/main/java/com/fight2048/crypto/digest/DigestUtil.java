...
public class DigestUtil {
    ...
    public static String md5Hex16(String data) {
        return md5Hex16(data, StandardCharsets.UTF_8);
    }
     ...
     * @since 4.6.0
     */
    public static String md5Hex16(InputStream data) throws IOException {
        return new MD5().digestHex16(data);
    }
     ...
     * @since 4.6.0
     */
    public static String md5Hex16(File file) throws IOException {
    ...
    public static byte[] sha256(String data) {
        return sha256(data, StandardCharsets.UTF_8.name());
    }
    ...
    public static String sha256Hex(String data) {
        return sha256Hex(data, StandardCharsets.UTF_8.name());
    }
