...
import com.fight2048.crypto.BCUtil;
import com.fight2048.crypto.CryptoException;
import com.fight2048.crypto.ECKeyUtil;
...
public class SM2 extends AbstractAsymmetricCrypto<SM2> {
     ...
     * * 在硬件签名中，返回结果为R+S，可以通过调用{@link com.fight2048.crypto.SmUtil#rsAsn1ToPlain(byte[])}方法转换之。
     *
     * @param data 加密数据
     * @return 签名
     */
