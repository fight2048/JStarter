...
import com.fight2048.crypto.asymmetric.AsymmetricAlgorithm;
import com.fight2048.crypto.asymmetric.RSA;
import com.fight2048.crypto.asymmetric.Sign;
import com.fight2048.crypto.asymmetric.SignAlgorithm;
import com.fight2048.crypto.digest.*;
import com.fight2048.crypto.symmetric.*;
import com.fight2048.crypto.symmetric.fpe.FPE;
...
public class SecureUtil {
    ...
    public static String generateAlgorithm(AsymmetricAlgorithm asymmetricAlgorithm, DigestAlgorithm digestAlgorithm) {
        ...
        return String.format("%swith%s", digestPart, asymmetricAlgorithm.getValue());
    }
     ...
     *
     * @param in       {@link InputStream} 如果想从文件读取.keystore文件
     * @param password 密码
     ...
     * @return MD5字符串
     */
    public static String md5(File dataFile) throws IOException {
     ...
     * @return SHA1字符串
     */
    public static String sha1(File dataFile) throws IOException {
    ...
    public static HMac hmac(HmacAlgorithm algorithm, String key) {
        return new HMac(algorithm, key.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public static HMac hmacMd5(String key) {
        return hmacMd5(key.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public static byte[] decode(String key) {
        return Pattern.matches("^[a-fA-F0-9]+$", key) ? HexUtils.decodeHex(key) : Base64.getDecoder().decode(key);
    }
